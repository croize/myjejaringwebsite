...
class MyjejaringController extends Controller
{
    ...
    {
      $s = Header::all();
      return view('myjejaring.index')->with('sindex', $s);
    }
    ...
    {
      $edit = Header::find($id);
      return view('myjejaring.update')->with('edithead', $edit);
    }
   ...
   'imgvid' => 'image',
    ...
    {
      $file = Header::find($id);
      Storage::delete($file->imgback);
      Storage::delete($file->imgvid);
      $file->delete();
    }
}
