...
<section class="mbr-section mbr-section-hero mbr-section-full mbr-parallax-background mbr-after-navbar" id="wawheader" style="background-image: url(/storage/header/{{$edithead->imgback}});">
                ...
                <div class="batas">
                    <div class="mbr-table-md-up">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <h6 class="alala"><span style="font-weight: normal; ">
                              {{$edithead->titlehead}} <br>
                                <p>{{$edithead->deschead}}</p>
                                <div class="mbr-section-btn">
                                  <a class="btn btn-warning"  href="{{$edithead->link}}">MORE</a>
                                </div>
                            </span>
                            </h6>
                        </div>
                ...
                <div class="x_panel" style="height:auto;">
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group" id="smgridbtn">
                        <div class="col-md-12">
                        <center>
