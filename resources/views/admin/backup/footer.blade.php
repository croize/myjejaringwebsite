...
<div class="col-lg-4">
  ...
  {{csrf_field()}}
            <label for="fullname">Label</label>
                    ...
                    <textarea id="message" rows="6"  required="required" class="form-control"  data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.." name="address" value="{{$editfoot->address}}">{{$editfoot->address}}</textarea>
                    <br/>
...
<div class="col-lg-4">
            ...
            <label for="fullname">Label</label>
                    ...
                    <label for="message">description</label>
                    <textarea id="message" rows="6"  required="required" class="form-control"  data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.."
